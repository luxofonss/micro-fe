export const fetchRemote = (url, remoteName) =>
	new Promise((resolve, reject) => {
		console.log("document: ", document.ATTRIBUTE_NODE);
...
export const loadComponent =
	...
	async () => {
		if (!(remoteName in window)) {
			...
			console.log("fetchedContainer:: ", fetchedContainer);
			console.log(`${remoteUrl.replace(/\/$/, "")}/remoteEntry.js`);
			// eslint-disable-next-line no-undef
			await fetchedContainer.init(__webpack_share_scopes__[scope]);
		}
		console.log("window:: ", window);
		console.log("window:: ", remoteName in window);
